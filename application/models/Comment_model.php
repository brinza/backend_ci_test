...
class Comment_model extends CI_Emerald_Model
{
    ...
    public function get_likes()
    {
        $this->is_loaded(true);
        if (!$this->likes) {
            /** @see Comment_likes_model::comment_id */
            $this->likes = Comment_likes_model::getBy(['comment_id' => $this->get_id()]);
        }
        return $this->likes;
    }
    ...
    function __construct($id = NULL)
    {
        ...
        App::get_ci()->load->model(User_model::class);
        App::get_ci()->load->model(Comment_likes_model::class);
